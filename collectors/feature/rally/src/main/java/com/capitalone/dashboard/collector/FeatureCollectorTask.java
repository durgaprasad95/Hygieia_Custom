...
public class FeatureCollectorTask extends CollectorTask<FeatureCollector> {
	...
	public FeatureCollectorTask(TaskScheduler taskScheduler, FeatureRepository featureRepository,
			...
			FeatureSettings featureSettings) throws HygieiaException, NullPointerException {
	 ...
	 * gather data from the feature content source system and update the repository
	 * with retrieved data.
	 */
	@Override
