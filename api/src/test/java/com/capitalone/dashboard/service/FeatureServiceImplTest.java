...
public class FeatureServiceImplTest {
	...
	public void setup() {
		...
		// (ObjectId collectorId, String sId, String sStatus, String sState, Integer
		// sEstimate, String changeDate, boolean isDeleted,
		// String teamId, String sTeamChangeDate,
		// String sSprintID, String sSprintChangeDate, String sSprintBeginDate, String
		// sSprintEndDate,
		// String sEpicID, String sEpicChangeDate, String sEpicBeginDate, String
		// sEpicEndDate,
		// String sProjectID, String sProjectChangeDate, String sProjectBeginDate,
		...
		mockV1Feature = createFeature(v1CollectorId, "B-12345", "Accepted", "Inactive", 5, generalUseDate, true,
				"Team:124127", generalUseDate, "Timebox:12781205", generalUseDate, generalUseDate, maxDateWinner,
				"E-12345", generalUseDate, generalUseDate, generalUseDate, "Scope:231870", generalUseDate,
				generalUseDate, generalUseDate);

		// Jira Mock Feature
		// Mock feature 1
		mockJiraFeature = createFeature(jiraCollectorId, "0812345", "In Progress", "Active", 40, maxDateWinner, false,
				"08374321", maxDateWinner, "1232512", maxDateWinner, maxDateLoser, currentSprintEndDate, "32112345",
				maxDateWinner, generalUseDate, generalUseDate, "583482", maxDateWinner, maxDateWinner, maxDateWinner);

		// Mock feature 2
		mockJiraFeature2 = createFeature(jiraCollectorId2, "0812346", "Done", "Active", 50, maxDateLoser, false,
				"08374321", maxDateWinner, "1232512", maxDateWinner, maxDateLoser, currentSprintEndDate, "32112345",
				maxDateLoser, "", "", "583483", maxDateLoser, maxDateLoser, maxDateLoser);

		// Mock feature 3
		mockJiraFeature3_oldkanban = createFeature(jiraCollectorId3, "0812347", "Open", "Active", 40, maxDateLoser,
				false, "08374321", maxDateWinner, KANBAN_OLD_SPRINT_ID, maxDateWinner, KANBAN_START_DATE,
				KANBAN_END_DATE, "32112345", maxDateLoser, "", "", "583483", maxDateLoser, maxDateLoser, maxDateLoser);

		mockJiraFeature4_sprintkanban = createFeature(jiraCollectorId3, "0812347", "In Progress", "Active", 50,
				maxDateLoser, false, "08374321", maxDateWinner, "11111", maxDateWinner, KANBAN_START_DATE,
				KANBAN_END_DATE, "32112345", maxDateLoser, "", "", "583483", maxDateLoser, maxDateLoser, maxDateLoser);

		mockJiraFeature5_nullkanban = createFeature(jiraCollectorId3, "0812347", "Done", "Active", 60, maxDateLoser,
				false, "08374321", maxDateWinner, "22222", maxDateWinner, "", "", "32112345", maxDateLoser, "", "",
		...
		mockComponent.getCollectorItems().put(CollectorType.AgileTool, Arrays.asList(mockItem2, mockItem3, mockItem4));
	...
	public void testGetFeatureEstimates_ManySameSuperFeatures_OneSuperFeatureRs() {
		...
		when(featureRepository.findByActiveEndingSprints(Mockito.anyString(), Mockito.anyString(), Mockito.any(),
		...
		assertThat("There should only be one result even with multiple same super features over several sub features",
	...
	public void testGetCurrentSprintDetail_ValidKanbanTeam_ShowKanban() {
		...
		when(featureRepository.findByUnendingSprints(Mockito.anyString(), Mockito.anyString(), Mockito.any(),
				Mockito.anyBoolean())).thenReturn(Arrays.asList(mockJiraFeature3_oldkanban));
	...
	public void testGetRelevantStories_Kanban() {
		...
		when(featureRepository.findByUnendingSprints(Mockito.anyString(), Mockito.anyString(), Mockito.any(),
				Mockito.anyBoolean()))
						.thenReturn(Arrays.asList(mockJiraFeature3_oldkanban, mockJiraFeature4_sprintkanban));
		when(featureRepository.findByNullSprints(Mockito.anyString(), Mockito.anyString(), Mockito.any(),
				Mockito.anyBoolean())).thenReturn(Arrays.asList(mockJiraFeature5_nullkanban));
	...
	public void testGetAggregatedSprintEstimates_Scrum() {
		...
		DataResponse<SprintEstimate> result = featureService.getAggregatedSprintEstimates(mockComponentId,
				mockJiraFeature3_oldkanban.getsTeamID(), Optional.of("scrum"), Optional.of("storypoints"));
	...
	public void testGetAggregatedSprintEstimates_Kanban() {
		...
		DataResponse<SprintEstimate> result = featureService.getAggregatedSprintEstimates(mockComponentId,
				mockJiraFeature3_oldkanban.getsTeamID(), Optional.of("kanban"), Optional.of("storypoints"));
	...
	private Feature createFeature(ObjectId collectorId, String sId, String sStatus, String sState, Integer sEstimate,
			String changeDate, boolean isDeleted, String teamId, String sTeamChangeDate, String sSprintID,
			String sSprintChangeDate, String sSprintBeginDate, String sSprintEndDate, String sEpicID,
			String sEpicChangeDate, String sEpicBeginDate, String sEpicEndDate, String sProjectID,
			String sProjectChangeDate, String sProjectBeginDate, String sProjectEndDate) {
