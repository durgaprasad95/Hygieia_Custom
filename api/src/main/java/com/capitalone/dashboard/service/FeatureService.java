...
public interface FeatureService {
	 ...
	 */
	DataResponse<List<Feature>> getStory(ObjectId componentId, String storyNumber);
	 ...
	 */
	@Deprecated
	DataResponse<List<Feature>> getTotalEstimate(ObjectId componentId, String teamId, Optional<String> agileType,
			Optional<String> estimateMetricType);
	 ...
	 */
	@Deprecated
	DataResponse<List<Feature>> getInProgressEstimate(ObjectId componentId, String teamId, Optional<String> agileType,
			Optional<String> estimateMetricType);
	 ...
	 */
	@Deprecated
	DataResponse<List<Feature>> getDoneEstimate(ObjectId componentId, String teamId, Optional<String> agileType,
			Optional<String> estimateMetricType);

	/**
	 * Retrieves estimate done of all features in the current sprint(s) for the
	 * current team
	 * 
	 * @param componentId
	 *            The ID of the related UI component that will reference collector
